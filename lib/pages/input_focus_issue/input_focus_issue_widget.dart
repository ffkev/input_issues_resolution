...
import 'input_focus_issue_model.dart';
export 'input_focus_issue_model.dart';

class InputFocusIssueWidget extends StatefulWidget {
  const InputFocusIssueWidget({super.key});

  static String routeName = 'InputFocusIssue';
  static String routePath = '/inputFocusIssue';

  @override
  State<InputFocusIssueWidget> createState() => _InputFocusIssueWidgetState();
}

class _InputFocusIssueWidgetState extends State<InputFocusIssueWidget> {
  late InputFocusIssueModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InputFocusIssueModel());
